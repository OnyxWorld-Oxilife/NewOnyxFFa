    ...
    public void onEnable() {
        ...
        try {
            ...
            if (!configFile.exists()) {
                ...
                lore.add("§aOuvrir le Menu");
                configConfiguration.set("NewOnyxFFa.Config.Menu.Item.Material", "COMPASS");
                configConfiguration.set("NewOnyxFFa.Config.Menu.Item.Name", "Boussole");
                ...
                configConfiguration.set("NewOnyxFFa.Config.Menu.Item.Menu.Name", "Menu");
                lore.clear();
                lore.clear();
                lore.add("§aCliquer Pour");
                lore.add("§aRejoindre le FFa");
                configConfiguration.set("NewOnyxFFa.Config.Menu.Item.Inventory.Slots", 27);
                configConfiguration.set("NewOnyxFFa.Config.Menu.Item.Inventory.Items.Ffa.Name", "§6RushFFa");
                configConfiguration.set("NewOnyxFFa.Config.Menu.Item.Inventory.Items.Ffa.Material", "GOLD_AXE");
                configConfiguration.set("NewOnyxFFa.Config.Menu.Item.Inventory.Items.Ffa.Lore", lore.toArray());
                configConfiguration.set("NewOnyxFFa.Config.Menu.Item.Inventory.Items.Ffa.Enchanted", true);
                configConfiguration.set("NewOnyxFFa.Config.Menu.Item.Inventory.Items.Ffa.Slot", 11);
                lore.clear();
                lore.add("§aCliquer Pour");
                lore.add("§aRejoindre le Box");
                configConfiguration.set("NewOnyxFFa.Config.Menu.Item.Inventory.Slots", 27);
                configConfiguration.set("NewOnyxFFa.Config.Menu.Item.Inventory.Items.Box.Name", "§bBox");
                configConfiguration.set("NewOnyxFFa.Config.Menu.Item.Inventory.Items.Box.Material", "GOLD_SWORD");
                configConfiguration.set("NewOnyxFFa.Config.Menu.Item.Inventory.Items.Box.Lore", lore.toArray());
                configConfiguration.set("NewOnyxFFa.Config.Menu.Item.Inventory.Items.Box.Enchanted", true);
                configConfiguration.set("NewOnyxFFa.Config.Menu.Item.Inventory.Items.Box.Slot", 15);
                configConfiguration.set("NewOnyxFFa.Config.SpawnCommand.TimerUntilTeleportation", 5);
                configConfiguration.set("NewOnyxFFa.Config.MinY", 5);
                lore.clear();
